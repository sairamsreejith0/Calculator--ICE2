...
if __name__ == '__main__':
    while (True):  # continuously prompts menu to user until exit
        # giving options to user to choose addition,subtraction,multiplication,division or exit
        print("menu")
        print("1.addition")
        print("2.subtraction")
        ...
        if choice == 1:  # if the user gives 1 as input perform addition
            ...
            print('addition of {} and {} is {}'.format(number1, number2, Calculator.addition(
                number1, number2)))  # calling addition function by passing number1 and number2
        elif choice == 2:  # if the user gives 2 as input perform subtraction
            print("enter a number")
            number1 = int(input())  # reading 1st number
            print("enter a number")
            number2 = int(input())  # reading 2nd number
            print('subtraction of {} and {} is {}'.format(number1, number2, Calculator.subtraction(
                number1, number2)))  # calling subtraction function by passing number1 and number2
        elif choice == 3:  # if the user gives 3 as input perform multiplication
            print("enter a number")
            number1 = int(input())  # reading 1st number
            print("enter a number")
            number2 = int(input())  # reading 2nd number
            print('multiplication of {} and {} is {}'.format(number1, number2, Calculator.multiplication(
                number1, number2)))  # calling multiplication function by passing number1 and number2
